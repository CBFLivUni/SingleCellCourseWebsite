...
-   For windows users: [R v4.4.3](https://cran.r-project.org/bin/windows/base/R-4.4.3-win.exe)

-   For macOS users: [R v4.4.3](https://cran.r-project.org/bin/macosx)

### Install extras

We will be installing some R packages which require compiling from the source code. To do this:

-   If you are working on Windows you will need to install [Rtools v4.4](https://cran.r-project.org/bin/windows/Rtools/rtools44/files/rtools44-6459-6401.exe)
...
-   Open RStudio Download this [zip file](https://pgb.liv.ac.uk/~jsoul/refresher.zip) and unzip it.
